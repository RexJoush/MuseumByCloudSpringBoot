...
public class PodDefinition {
    ...
    private String namespace;   // pod 命名空间
    private String phase;       // pod 状态， Succeeded, Pending, Running
    ...
    public PodDefinition() {
    }

    public PodDefinition(String name, String namespace, String phase, int restartCount, String cpuUsage, String memoryUsage, String nodeName, String podIP) {
        this.name = name;
        this.namespace = namespace;
        this.phase = phase;
        this.restartCount = restartCount;
